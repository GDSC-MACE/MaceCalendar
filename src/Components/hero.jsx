...
const Hero = () => {
  return <section className=" h-dvh hero_background overflow-hidden">
  {/* <Loader/> */}
    ...
    <h1 className=" text-slate-50 text-5xl font-bold px-1 drop-shadow-lg">
         ...
         <Link to='/upComingEvents' className=" text-lg w-10 h-10 shadow-md hover:shadow-2xl  bg-white rounded-full place-items-center flex items-center gap-5  absolute overflow-hidden hover:w-32 group ease-in-out duration-700">
         ...
         <p className=" pb-1 pl-2 translate-x-2 group-hover:translate-x-0 ease-in-out duration-700 font-semibold text-blue-600">explore</p></Link>
         </div>
