        ...
        <div>
            <div className="w-[500px] bg-slate-800 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative ">
                ...
                <form action="/adminpanel" method="POST">
                    ...
                    <input type="text" id="username" name="username" required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-blackq focus:border-blue-600 peer" placeholder=""/>
                    ...
                    <div className="relative my-4">
                    <input type="password" id="password" name="password" required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-black focus:border-blue-600 peer" placeholder=""/>
                    ...
                    <button type="submit" className="w-full mb-4 text-[18px] mt-6 rounded bg-slate-500 py-2 hover:bg-slate-600 transition-colors duration-300">
                      Login 
                    </button>
                </form>
            </div>
